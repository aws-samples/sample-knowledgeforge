...
const scheduled = new EventBridgeRuleConstruct(this, 'CronRule', {
  ruleName: 'orgAlpha-d-use1-daily-sync',
...
eventbridge_rules:
  order-created:
    rule_name: "orgAlpha-d-use1-order-created"
    description: "Triggers on new order events"
    event_pattern:
      source: ["com.orgalpha.orders"]
    ...
    targets:
      - type: lambda
        function_arn: "arn:aws:lambda:us-east-1:000000000012:function:order-handler"
    tags:
      Environment: dev
```
