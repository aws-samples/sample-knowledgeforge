...
def _compute_freshness_score(article_id):
    ...
    if item.get("source_system", "").startswith("PROBLEM_FINDER"):
        return 10
...
def run_enrichment(
    ...
    """
    from html_utils import extract_placeholders, restore_placeholders
    ...
    try:
        ...
        if enrichment_applied:
            ...
            if score_improved:
                ...
                # Write lean JSON payload for ServiceNow review
                enriched_html = enriched_bytes.decode("utf-8")
                output_payload = {
                    "src_kb_article_id": article_id,
                    "source_system": source_system,
