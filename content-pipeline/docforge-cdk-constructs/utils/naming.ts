 ...
 * - tenant_id: orgalpha, orgbeta, shared, etc.
...
export class NamingUtil {
   ...
   *   prefixName('poll_email', 'orgAlpha')   → 'orgAlpha-d-use1-poll_email'
   *
   * @param functionality  Short functional name (e.g. 'poll_email', 'survey_bot')
   * @param tenantOverride Optional tenant prefix override (e.g. 'orgAlpha', 'orgBeta').
   ...
   * Example: orgAlpha-d-use1-order-processor
   */
   ...
   * Example: /orgAlpha-d-use1/lambda/OrderProcessor/arn
   */
