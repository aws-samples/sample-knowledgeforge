...
export class ContentSynthesisStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    // ── Resource tags ───────────────────────────────────────────────
    Tags.of(this).add("project", "content-synthesis");
    ...
    const dlq = new sqs.Queue(this, "DeadLetterQueue", {
      queueName: "content-synthesis-dlq",
      retentionPeriod: Duration.days(14),
      encryption: sqs.QueueEncryption.SQS_MANAGED,
    });

    const processingQueue = new sqs.Queue(this, "ProcessingQueue", {
      queueName: "content-synthesis-queue",
    ...
    new cloudwatch.Alarm(this, "DlqAlarm", {
      alarmName: "content-synthesis-dlq-messages",
    ...
    const outputBucket = new s3.Bucket(this, "OutputBucket", {
      bucketName: "content-synthesis-output-bucket",
    ...
    const metricsTable = new dynamodb.Table(this, "MetricsTable", {
      tableName: "content-synthesis-metrics",
    ...
    const ecrRepo = new ecr.Repository(this, "EcrRepository", {
      repositoryName: "content-synthesis",
    ...
    const logGroup = new logs.LogGroup(this, "PipelineLogGroup", {
      logGroupName: "content-synthesis-logs",
    ...
    const cluster = new ecs.Cluster(this, "PipelineCluster", {
      clusterName: "content-synthesis-cluster",
      vpc,
    });
